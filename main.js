...
.contact-wrapper p{
    margin-top: 5px;
}`, "",{"version":3,"sources":["webpack://./src/style/style.css"],"names":[],"mappings":"AAEA;IACI,+BAA+B;AACnC;AACA;IACI,yBAAyB;IACzB,SAAS;IACT,UAAU;IACV,SAAS;AACb;AACA;IACI,qBAAqB;IACrB,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,uBAAuB;IACvB,SAAS;IACT,gBAAgB;IAChB,YAAY;AAChB;AACA;IACI,aAAa;AACjB;;AAEA,cAAc;AACd;IACI,kBAAkB;AACtB;AACA;IACI,mBAAmB;AACvB;AACA;IACI,gBAAgB;IAChB,kBAAkB;IAClB,eAAe;AACnB;AACA;IACI,iBAAiB;IACjB,mBAAmB;AACvB;;AAEA,gBAAgB;AAChB;IACI,aAAa;IACb,sBAAsB;IACtB,mBAAmB;AACvB;AACA;IACI,mBAAmB;IACnB,eAAe;IACf,eAAe;AACnB;AACA;IACI,aAAa;AACjB;AACA;IACI,YAAY;IACZ,YAAY;AAChB;AACA;IACI,iBAAiB;AACrB;;AAEA,iBAAiB;AACjB;IACI,gBAAgB;IAChB,mBAAmB;IACnB,eAAe;AACnB;AACA;IACI,kBAAkB;AACtB;AACA;IACI,eAAe;AACnB","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Poppins:wght@400;900&display=swap');\n\n*{\n    font-family: Poppins,sans-serif;\n}\nbody{\n    background-color: #ffd230;\n    margin: 0;\n    padding: 0;\n    border: 0;\n}\na{\n    text-decoration: none;\n    color: black;\n}\n\n#navbar{\n    display: flex;\n    justify-content: center;\n    gap: 3rem;\n    margin-top: 10px;\n    width: 100vw;\n}\n#navbar a{\n    padding: 20px;\n}\n\n/* home page */\n.wrapper{\n    text-align: center;\n}\n.wrapper img{\n    border-radius: 10px;\n}\n.home-wrapper h1{\n    margin-top: -5px;\n    margin-bottom: 0px;\n    font-size: 72px;\n}\n.home-wrapper p{\n    margin-top: -10px;\n    margin-bottom: 30px;\n}\n\n/* recipe page */\n.recipe-wrapper{\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n}\n.recipe-wrapper h1{\n    margin-bottom: 10px;\n    font-size: 56px;\n    margin-top: 0px;\n}\n.cards-wrapper{\n    display: flex;\n}\n.card{\n    width: 300px;\n    padding: 5px;\n}\n.card p{\n    margin-top: -15px;\n}\n\n/* contact page */\n.contact-wrapper h1{\n    margin-top: 20px;\n    margin-bottom: 20px;\n    font-size: 56px;\n}\n.contact-wrapper h3{\n    margin-bottom: 0px;\n}\n.contact-wrapper p{\n    margin-top: 5px;\n}"],"sourceRoot":""}]);
// Exports
...
function homePage(){
    ...
    image.src = _assets_hero_jpg__WEBPACK_IMPORTED_MODULE_0__["default"];
